...
const ChatEngine = (() => {
    ...
    function renderBubble(msg) {
        ...
        switch (msg.message_type) {
            case 'image':
                content = `
                    <div class="chat-image-wrap" onclick="ChatEngine.openImage(this)">
                        <img src="/kurir/${msg.file_path}" alt="${escHtml(msg.file_name)}" loading="lazy">
                    </div>
            ...
            case 'file':
                content = `
                    <a href="/kurir/${msg.file_path}" target="_blank" class="chat-file-card" download="${escHtml(msg.file_name)}">
