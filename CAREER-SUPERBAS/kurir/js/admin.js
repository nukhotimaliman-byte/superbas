...
async function loadCandidates() {
    ...
    try {
        ...
        document.getElementById('candidateTableBody').innerHTML =
            '<tr><td colspan="35" class="table-empty">Gagal memuat data: ' + String(e.message || e) + '</td></tr>';
    }
}
...
function renderCandidateTable() {
    ...
    if (allCandidates.length === 0) {
        tbody.innerHTML = '<tr><td colspan="35" class="table-empty">Belum ada kandidat</td></tr>';
        updatePager();
        return;
    }
...
const TEMPLATE_HEADERS = [
    ...
    'Tipe/Jenis SIM', 'Nomor SIM', 'Armada', 'Status User', 'Tempat Lahir', 'Tanggal Lahir',
...
function downloadTemplate() {
    ...
    const sampleData = [
        ...
        ['', 'john_doe', '', 'John Doe', '3201234567890001', '081234567890', 'john@email.com',
         'B2', '123456789012', 'CDD', 'Belum Pemberkasan', 'Jakarta', '1995-06-15',
         'Jl. Merdeka No.1', 'SMA', 'Tidak',
         '', 'Ada', 'Tidak Ada', '',
         'Makobas', ''],
        ['', 'jane_doe', '', 'Jane Doe', '3201234567890002', '081298765432', 'jane@email.com',
         'B2', '987654321098', 'Wingbox', 'Sudah Pemberkasan', 'Bandung', '1993-03-22',
...
async function loadDropdownOptions() {
    try {
        ...
        if (data.ok && data.options) {
            ...
            // Update bulk status select in admin
