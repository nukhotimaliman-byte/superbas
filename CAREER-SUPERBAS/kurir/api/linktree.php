...
$action = $_GET['action'] ?? '';
$TABLE  = 'krr_linktree';  // Kurir-specific linktree table
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && $action === 'list') {
    ...
    $DEMO_LINKS = [
        ...
        ['id'=>11,'title'=>'TikTok BAS',             'url'=>'https://tiktok.com/@bas',        'icon'=>'🎵', 'icon_key'=>'tiktok',  'description'=>'Konten seru seputar kurir BAS',         'group_name'=>'Social Media', 'group_order'=>3],
    ];
    try {
